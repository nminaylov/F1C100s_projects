...
void tve_init(tve_mode_e mode)
{
    ...
    write32(F1C100S_TVE_BASE+TVE_DAC1, 0x433810A1);
    if (mode == TVE_MODE_NTSC) // NTSC
    {
        write32(F1C100S_TVE_BASE+TVE_CFG1, 0x07030000);
        write32(F1C100S_TVE_BASE+TVE_NOTCH_DELAY, 0x00000120);
        ...
        write32(F1C100S_TVE_BASE+TVE_CHROMA_BW, 0x00000000);
        write32(F1C100S_TVE_BASE+TVE_CFG2, 0x00000101);
        write32(F1C100S_TVE_BASE+TVE_RESYNC, 0x000E000C);
    ...
    {
        write32(F1C100S_TVE_BASE+TVE_CFG1, 0x07030001);
        write32(F1C100S_TVE_BASE+TVE_NOTCH_DELAY, 0x00000120);
        ...
        write32(F1C100S_TVE_BASE+TVE_CBCR_LEVEL, 0x00002828);
        write32(F1C100S_TVE_BASE+TVE_TINT_PHASE, 0x00000000);
        write32(F1C100S_TVE_BASE+TVE_B_WIDTH, 0x0016447E);
        write32(F1C100S_TVE_BASE+TVE_CBCR_GAIN, 0x0000E0E0);
        write32(F1C100S_TVE_BASE+TVE_SYNC_LEVEL, 0x001000F0);
        write32(F1C100S_TVE_BASE+TVE_WHITE_LEVEL, 0x01E80320);
        write32(F1C100S_TVE_BASE+TVE_ACT_LINE, 0x000005A0);
        write32(F1C100S_TVE_BASE+TVE_CHROMA_BW, 0x00000000);
        write32(F1C100S_TVE_BASE+TVE_CFG2, 0x00000101);
        write32(F1C100S_TVE_BASE+TVE_RESYNC, 0x800D000C);
        write32(F1C100S_TVE_BASE+TVE_SLAVE, 0x00000000);
        write32(F1C100S_TVE_BASE+TVE_CFG3, 0x00000000);
        write32(F1C100S_TVE_BASE+TVE_CFG4, 0x00000000);
    }
    write32(F1C100S_TVE_BASE+TVE_ENABLE, 1);
}
